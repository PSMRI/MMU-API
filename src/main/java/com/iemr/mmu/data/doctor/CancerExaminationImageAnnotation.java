...
@Entity
@Table(name = "t_cancerimageannotation")
public class CancerExaminationImageAnnotation {
	@Id
	...
	public CancerExaminationImageAnnotation(Long iD, Long beneficiaryRegID, Long benVisitID,
		...
		this.cancerImageID = cancerImageID;
	...
	public Integer getCancerImageID() {
		return cancerImageID;
	}

	public void setCancerImageID(Integer cancerImageID) {
		this.cancerImageID = cancerImageID;
	}
