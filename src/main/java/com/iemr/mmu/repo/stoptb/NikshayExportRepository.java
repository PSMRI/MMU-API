...
public class NikshayExportRepository {
	 ...
	 * mapping/validation happens in the service layer, not here. */
	public record NikshayRawRow(String firstName, String middleLastName, Integer age, String gender, String phone,
			String address, String stateName, String districtName, String healthFacility, String village,
			String pincode, String maritalStatus, String caste, String occupation, String socioeconomicStatus,
			String chiefComplaint, String hivStatus, Boolean isHivPos) {
	}
